        ...
        <section className="project container mt-4 px-3" id="services">
          ...
          <div className="row text-align-center mt-4" >
            <div className="col-lg-3 mt-5">
                  ...
                  <h4 className="card-title text-center mt-3 fw-bold" style={fontFamily}> Free Shipping</h4>
                  <p className='text-center mt-4'>International Shipping available for <br/> all 
                    orders over $99</p>
